...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/d8235f7ce4e8da950600401d79a58eb5c1250a20/H/HiGHS/HiGHS/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.")
...
* git repository: https://github.com/ERGO-Code/HiGHS.git (revision: `60ad175979bbf6be309de3992adc9852625d1e7b`)
