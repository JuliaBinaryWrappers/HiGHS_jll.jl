# Autogenerated wrapper script for HiGHS_jll for x86_64-apple-darwin14-libgfortran4-cxx11
...
const libhighs_splitpath = ["lib", "libhighs.1.0.0.dylib"]
...
const libhighs = "@rpath/libhighs.1.0.dylib"
...
# This must be `const` so that we can use it with `ccall()`
const libipx = "@rpath/libipx.dylib"
