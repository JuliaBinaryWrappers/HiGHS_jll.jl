...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import HiGHS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("8fd58aa0-07eb-5a78-9b36-339c94fd15ea"))
platforms = [Pkg.Artifacts.unpack_platform(e, "HiGHS", artifacts_toml) for e in artifacts["HiGHS"]]
...
if best_platform === nothing
    @debug("Unable to load HiGHS; unsupported platform $(triplet(platform_key_abi()))")
else
